...
final class Version20230906081232 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tricks_image (id INT AUTO_INCREMENT NOT NULL, trick_id INT NOT NULL, name LONGTEXT NOT NULL, INDEX IDX_1C0D3A36B281BE2E (trick_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
